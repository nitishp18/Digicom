...
if($_POST)
{
    $to_email       = "bhatvicky59@gmail.com"; //Recipient email, Replace with own email here
    ...
    $type_of_feedback  = filter_var($_POST["type_of_feedback"], FILTER_SANITIZE_STRING);
    $feedback_against  = filter_var($_POST["feedback_against"], FILTER_SANITIZE_STRING);
    $feedback_message  = filter_var($_POST["feedback_message"], FILTER_SANITIZE_STRING);
